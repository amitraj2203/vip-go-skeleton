  ...
  public static function get_dynamic_attrs() {
    $attrs = array(
      ...
      'biz_address_format'            => array(
        'default'     => __('<h3>{$biz_name}</h3><br/>{$biz_address1}<br/>{$biz_address2}<br/>{$biz_city}, {$biz_state}<br/>{$biz_postcode} {$biz_country}', 'memberpress-pdf-invoice'),
        'validations' => array(),
      ),

      'biz_cus_address_format'        => array(
        'default'     => __('{$user_full_name}<br/>{$user_address_single}<br/>{$user_email}', 'memberpress-pdf-invoice'),
        'validations' => array(),
      ),
      'biz_invoice_notes'             => array(
        'default'     => sprintf( __('<h3>NOTES:</h3><br/>Thank you for choosing %1$s', 'memberpress-pdf-invoice'), '{$biz_name}' ),
        'validations' => array(),
      ),
      'biz_invoice_footnotes'         => array(
        'default'     => sprintf( __('Invoice was created on a computer and is valid without the signature and seal.<br/>%1$s', 'memberpress-pdf-invoice'), '{$site_domain}' ),
        'validations' => array(),
      ),
