...
if (!function_exists('qode_scripts')) {
    function qode_scripts() {
		...
		wp_enqueue_script("tingle", QODE_ROOT."/js/plugins/tingle.min.js", array(), false, true);
		wp_enqueue_script("slick", QODE_ROOT."/slick/slick.min.js", array(), false, true);
...
/* 
Added By: Joshua Lisojo
Enqueue CSS for Event's Page
Enqueues the external CSS file 
*/
add_action( 'wp_enqueue_scripts', 'schnps_external_styles' );
function schnps_external_styles() {
 
    wp_register_style( 'event-css', get_stylesheet_directory_uri().'/css/custom-styles/schnps-event-styles.css', array(), '10.16.23' );
    wp_enqueue_style( 'event-css' );

	wp_register_style( 'careers-css', get_stylesheet_directory_uri().'/css/custom-styles/schnps-careers-styles.css', array(), '6.9' );
    wp_enqueue_style( 'careers-css' );

	wp_register_style( 'legal-css', get_stylesheet_directory_uri().'/css/custom-styles/schnps-legal-styles.css', array(), '5.8.4' );
    wp_enqueue_style( 'legal-css' );

	wp_register_style( 'tingle-modal-css', get_stylesheet_directory_uri().'/css/tingle.min.css' );
    wp_enqueue_style( 'tingle-modal-css' );

	wp_register_style( 'slick-css', get_stylesheet_directory_uri().'/slick/slick.css' );
    wp_enqueue_style( 'slick-css' );

	wp_register_style( 'slick-theme-css', get_stylesheet_directory_uri().'/slick/slick-theme.css' );
...
// Richael Break the Site below :P
